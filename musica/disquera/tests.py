...
class TestDisqueraView(APITestCase):
    ...
    def test_recuperar_registro_por_ID(self):
        ...
        """
        detalle = reverse("disquera:detalle", kwargs={"pk": self.disquera.id})
    ...
    def test_PUT_vs_BD(self):
        ...
        actualizacion = reverse("disquera:detalle", kwargs={"pk": self.disquera.id})

        data_update = {
            "usuario": self.test_user1.pk,
            "nombre": "nueva disquera update",
            "direccion": "nueva direccion update",
        ...
        self.assertEqual(respuesta_actualizacion.data["direccion"], resultado.direccion)
        self.assertEqual(respuesta_actualizacion.data["telefono"], resultado.telefono)
    ...
    def test_DELETE(self):
        ...
        url_delete = reverse("disquera:detalle", kwargs={"pk": self.disquera.id})
        ...
        recuperar_registro = Disquera.objects.filter(pk=self.disquera.id).exists()
